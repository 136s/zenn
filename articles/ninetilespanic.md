...
これで 1 -26 のお題の得点パターンのファイルの中にその得点パターンになる町パターンが抽出されます。
執筆時点で計算中ですが、筆者の環境では 5 日くらいかかりそうです。

## お題セットごとの最適解

お題カードは 26 枚あり、そこから 3 枚ランダムに選ぶので、$_{26}\mathrm{C}_3=2600$ 通りのお題セットがありえます。
...
ちなみに、お題 4 は全て 0 点設定をしてるので、実質的に 2 つのお題セットで最高得点となる町パターンも抽出していることになります。

|お題セット|3 つとも最高得点となる町の数|
|:----|----:|
|(1, 4, 11)|696|
|(1, 4, 20)|1|
|(1, 4, 25)|2338|
