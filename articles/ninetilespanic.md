...
たとえば、以下の町は 71 のお題セットについて最適解となります。全てのリストは[ナインタイルパニックの最適解](https://zenn.dev/136/articles/ntp-win-town)にまとめました。
![town: 053861274040251371](/images/min/053861274040251371_6694684.png)
...
最適解となれるお題セットが最多となるのは、得点が 3, 3, 1, 0, 7, 6, 4, 0, 4, 2, 3, 2, 1, 3, -2, 0, 2, 3, 1, 0, 5, 5, 3, 2, 3, 3 となるお題シノニムで、以下の 71 個のお題セットについて最適解となれます。
